            ...
            <form method="post" action="login-post.php">
                <fieldset>
                    ...
                    <ul class="pageitem">
                        <li class="smallfield">
                            ...
                            <input placeholder="<?php //echo $_INPUT_HINT ?>Case Sensitve" name="password" type="text" autocapitalize="off" autocomplete="off" autocorrect="off" style="width:60%"/>
                        </li>
                    </ul>
                    <ul class="pageitem">
                        <li class="button">
                            <input type="submit" value="<?php //echo $_BUTTON ?>Login" />
                        </li>
                    </ul>
                </fieldset>
                ...
                <ul class="pageitem">
                    <li class="menu">
                        ...
                        ?>
                        <a href="reg.php">
                            <span class="name" style="text-align:center!important;">Register</span>
