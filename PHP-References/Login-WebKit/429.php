...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="topbar" class="black">
            <div id="title"><?php echo $_TOP_BAR ?></div>
            <div id="leftbutton">
            </div>
        </div>
        
        <div id="content">
            <span class="graytitle"><?php echo $_HEADER_0 ?></span>
            
            <form method="post" action="onesearch.php">
                <fieldset>
                    <ul class="pageitem">
                        <li class="smallfield">
                            <span class="name" style="text-align:center!important; width:38%;"><?php echo $_ENTER_CODE ?></span>
                            <input placeholder="<?php echo $_INPUT_HINT ?>" name="p" type="text" autocapitalize="off" autocomplete="off" autocorrect="off" style="width:60%"/>
                        </li>
                    </ul>
                    <ul class="pageitem">
                        <li class="smallfield">
                            <span class="name" style="text-align:center!important; width:38%;">PSWD:</span>
                            <input placeholder="<?php echo $_INPUT_HINT ?>" name="p" type="text" autocapitalize="off" autocomplete="off" autocorrect="off" style="width:60%"/>
                        </li>
                    </ul>
                    <ul class="pageitem">
                        <li class="button">
                            <input type="submit" value="<?php echo $_BUTTON ?>" />
                        </li>
                    </ul>
                    <ul class="pageitem">
                        <li class="button">
            ...
            <br/><br/>
            <ul class="textbox">
                <?php echo $_COMING_NEXT ?>
                <?php echo $_WHATS_NEXT ?>
                <?php echo $_A5Q ?><br/>
                <?php echo $_A5A ?></ul>
        </div>
    </body>
