...
$(function(){
  ...
  $('#pics0').click(function(){
                  $(this).replaceWith("<li class='textbox' id='pics00'>Replace DNS</br><img src='cert/demo.PNG' /></li>")
                  });
  ...
  $('#pics1').click(function(){
                    $(this).replaceWith("<li class='textbox'>Installation</br><img src='cert/demo1.PNG' /><img src='cert/demo2.PNG' /></li>")
                    });
