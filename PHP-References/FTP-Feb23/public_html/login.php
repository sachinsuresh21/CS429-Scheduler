...
$servername = "suresh2.projects.cs.illinois.edu";
$userpwd = "cs428";
$databasename = "suresh2_schedulerApp";

//attempt connection
//$connect = mysql_connect($servername,$username,$userpwd);
$connect = new PDO("mysql:host=suresh2.projects.cs.illinois.edu;dbname=suresh2_schedulerApp", "suresh2_cs428", "cs428");
...
function signUp($user_name, $user_pwd)
{
	...
	$insert = $connect->execute(array(mysql_real_escape_string($_POST['user_name']), sha1($_POST['user_pass'])));
